		...
		<section className="pt-24 pb-16 px-4">
			<div className="container mx-auto text-center">
				<div className="max-w-4xl mx-auto flex flex-col items-center">
					...
					<p className="text-xl text-slate-600 mb-8 font-light leading-relaxed max-w-2xl">
						Um espaço sagrado de cura e autoconhecimento, onde a sabedoria
						ancestral encontra a terapia moderna
					</p>

					{/* Video Section */}
					<div className="relative max-w-2xl mx-auto mb-8 rounded-2xl overflow-hidden shadow-2xl w-full">
						<div className="aspect-video bg-gradient-to-br from-slate-800 to-slate-900 flex items-center justify-center">
							<iframe
								title="YouTube video player"
								width="100%"
								height="100%"
								src="https://www.youtube.com/embed/J17SYLruJgc"
								frameBorder="0"
